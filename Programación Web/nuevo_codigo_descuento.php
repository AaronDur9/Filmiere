...
<html>
    <head>
        <title>Nuevo código descuento</title>
        <meta charset="utf-8" />
    ...
    <body>
        <div class="contenedor">
            ...
            <div class="c_gestion_ag">
                ...
                <h2>NUEVO CÓDIGO DESCUENTO</h2>
                <div class="estilo_centrado">
                     <?php $formAnyadirCodigoDescuento = new \es\ucm\fdi\aw\FormularioAnyadirCodigoDescuento(); 
                     $formAnyadirCodigoDescuento->gestiona(); ?>
                </div>
		      </div>
           </div>
